...
export default class PoonpholIntranetWebPart extends BaseClientSideWebPart<IPoonpholIntranetWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IPoonpholIntranetProps> = React.createElement(
      PoonpholIntranet,
      {
